...
class PurchaseListAdapter (private var items: LinkedList<PurchaseList>, private val onPurchaseListClickListener: OnPurchaseListClickListener) : RecyclerView.Adapter<PurchaseListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.date.text = purchaseListRecycleView.date.toString()

        holder.bindView(purchaseListRecycleView, onPurchaseListClickListener)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.recycler_info_purchase_list, parent, false)
